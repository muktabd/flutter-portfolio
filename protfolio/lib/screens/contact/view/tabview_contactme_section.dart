...
class TabviewContactMeScreen extends StatefulWidget {
  const TabviewContactMeScreen({super.key});

  @override
  State<TabviewContactMeScreen> createState() => _TabviewContactMeScreenState();
}

class _TabviewContactMeScreenState extends State<TabviewContactMeScreen> {
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    GlobalImageLoader(
                                      imageUrl:
                                          homeInfoCon.infoDetails?.info?.socialMedia?.linkedin?.url,
                                      imagePath: Images.linkedIn,
                                      width: 30,
                                    ),
                                    GlobalImageLoader(
                                      imageUrl:
                                          homeInfoCon.infoDetails?.info?.socialMedia?.facebook?.url,
                                      imagePath: Images.facebook,
                                      width: 30,
                                    ),
                                    GlobalImageLoader(
                                      imageUrl:
                                          homeInfoCon.infoDetails?.info?.socialMedia?.xtwitter?.url,
