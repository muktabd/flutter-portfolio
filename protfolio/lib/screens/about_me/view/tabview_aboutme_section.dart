...
class TabViewAboutMeSection extends StatefulWidget {
  const TabViewAboutMeSection({super.key});

  @override
  State<TabViewAboutMeSection> createState() => _TabViewAboutMeSectionState();
}

class _TabViewAboutMeSectionState extends State<TabViewAboutMeSection> {
  @override
