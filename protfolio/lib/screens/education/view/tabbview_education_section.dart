...
class TabbViewEducationSection extends StatefulWidget {
  const TabbViewEducationSection({super.key});

  @override
  State<TabbViewEducationSection> createState() => _TabbViewEducationSectionState();
}

class _TabbViewEducationSectionState extends State<TabbViewEducationSection> {
  bool isHover = false;
