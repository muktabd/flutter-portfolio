...
class TabViewWorkExperiSection extends StatelessWidget {
  const TabViewWorkExperiSection({super.key});
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: GlobalText(str: workData[index].toFrom, fontSize: 12.0),
                              ),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                icon: Icon(Icons.open_in_new, size: 15.0, color: Colors.blueGrey),
                              ),
                            ],
                          ),
                          GlobalText(
