...
class LocalStorage {
  ...
  SharedPreferences get sharedPreference {
    ...
    log("pref status ?? $_sharedPrefInstance");
  ...
  void setString({required StorageKeys key, required String? value}) async {
  ...
  void setInt({required StorageKeys key, required int? value}) async {
