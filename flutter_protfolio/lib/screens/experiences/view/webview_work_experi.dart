...
class WebViewWorkExperiSection extends StatelessWidget {
  const WebViewWorkExperiSection({super.key});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          const CardTitleWidget(title: "Work Experiences", subTitle: "The Companies I have worked with"),
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            ...
                            // crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              GlobalText(str: workData[index].position, fontSize: 30.0, fontWeight: FontWeight.w700),
                              Container(
                                  ...
                                  return Padding(
                                    ...
                                    child:
                                        workData[index].roles
                                            .map(
                                              (roleText) =>
                                                  GlobalText(str: roleText, fontSize: 18.0, color: Colors.grey),
                                            )
                                            .toList()[i],
                                  );
                                },
