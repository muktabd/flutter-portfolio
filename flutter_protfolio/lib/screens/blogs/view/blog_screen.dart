...
class WebBlogSection extends StatefulWidget {
  const WebBlogSection({super.key});

  @override
  State<WebBlogSection> createState() => _WebBlogSectionState();
}

class _WebBlogSectionState extends State<WebBlogSection> {
  @override
  Widget build(BuildContext context) {
